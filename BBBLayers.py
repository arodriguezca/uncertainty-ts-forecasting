'''
    Adapted to time series from https://github.com/JACKHAHA363/BBBRNN
    by Alex
'''
...
from torch.nn import RNNBase, RNN, LSTM
...
class BBBRNN(BBBLayer):
    ...
    def __init__(self, input_size, hidden_size, 
                ...
                pi=0.25, logstd1=0, logstd2=-6, gpu=False, BBB=True,
                *args, **kwargs):
        super(BBBRNN, self).__init__(pi=0.25, logstd1=0, logstd2=-6, gpu=False, BBB=True, *args, **kwargs)
        self.mode = mode
